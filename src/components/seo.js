...
const SEO = () => {
    ...
    const title = `Paul Tomlinson: Building websites that your customers will love ❤️`
    const titleTemplate= `%s`
    const description= `Paul Tomlinson: Building websites that your customers will love ❤️`
