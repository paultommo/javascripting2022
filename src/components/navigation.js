    ...
    <div className="navigation-container">
        ...
        <ul className="navigation desktop">
          ...
          <li>
           ...
           <li>
            <a rel="noreferrer" target="_blank" href="https://www.instagram.com/paultommmo" style={{ display: 'flex', alignItems: 'center' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ marginTop: '0.1rem' }}>
